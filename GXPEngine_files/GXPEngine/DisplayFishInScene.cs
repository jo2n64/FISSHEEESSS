...
namespace GXPEngine
{
    class DisplayFishInScene : GameObject
    {
        ...
        void loadScene3(List<Food> foodList, List<Fish> fishListPerScene)
        {
            ...
            scene3Fishes[1] = new Fish(foodList, 5, "Deep water", "Pelican Eel", "is a deep-sea eel which takes its name from its large lower jaw which they can use to swallow prey much larger than itself. There have not been many interactions with living pelican eels as most specimens were found dead in fishing nets. They can grow up to length of 75 cm and can be found in most parts of the atlantic between the depth of 500 to 3,000 m.", 60000,3000,2000,3,200);
            scene3Fishes[2] = new Fish(foodList, 4, "Deep water", "Sloane's Viperfish", "is a deep sea dragonfish which stands out from other fish by having one of the highest teeth to body size ratio in comparison to other fish. They mostly feast on smaller fish and due to their low energy consumption it is estimated that they only have to eat a fish every 12 days. Its size can range from 64 mm to 260 mm and it can be found in most oceans between the depth of 200 m - 1000 m.",60000,3000,4000,2,500);
            scene3Fishes[3] = new Fish(foodList, 4, "Deep water", "Humpback Anglerfish", "is a species of black sea devil that is found most commonly at depths between 100 and 1500 meters in most parts of the chinese sea the eastern pacific ocean.The females have the unique ability to attract its prey with a small bioluminescent light attached to its forehead which gives the species its unique name. The mostly feed of smaller fish but can also consume fish heavier than itself.", 60000,3000,8000,3,500);
            scene3Fishes[4] = new Fish(foodList, 7, "Deep water", "Vampire Squid", "is a deep sea squid with a maximum length of 30 cm. The literal translation of its name means 'vampire squid from Hell'. It can be found in the depth of 600 to 900 metres. Its most unique features are its big red eyes and the way it curls its arms up outwards and wraps them around its body, turning itself inside-out in a way, exposing spikes to deter potential enemies..",60000,3000,20000,1,1000);
