...
namespace GXPEngine
{
    class DisplayFishInScene : GameObject
    {
        ...
        void loadScene2(List<Food> foodList, List<Fish> fishListPerScene)
        {
            ...
            scene2Fishes[2] = new Fish(foodList, 7, "Sea water", "Pallette Tang", "is easily identifiable and a favourite among aquarium keepers for its vibrant colors. They live in pairs or in small groups from east Africa to Australia. They mostly feast on algae and it can grow up to 30 cm. ");
